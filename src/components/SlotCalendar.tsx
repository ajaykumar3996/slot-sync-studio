        ...
        <CardContent className="flex justify-center p-6">
          <Calendar
            ...
            classNames={{
              ...
              day: "w-full h-12 p-0 font-normal aria-selected:opacity-100 rounded-lg hover:bg-accent/50 hover:text-accent-foreground focus:bg-accent focus:text-accent-foreground transition-colors",
              day_selected: "bg-primary/20 text-primary hover:bg-primary/30 hover:text-primary focus:bg-primary/30 focus:text-primary border border-primary/30 rounded-lg",
              day_today: "bg-accent/30 text-accent-foreground font-semibold rounded-lg",
